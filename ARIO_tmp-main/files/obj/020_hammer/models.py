...
target_trans_matrix_sphere = trimesh.transformations.translation_matrix([0, 0.7,0.7])
...
trans_matrix1 = trimesh.transformations.euler_matrix(0, -1.57,-1.57)
trans_matrix1[0,3] = 0
trans_matrix1[1,3] = 0.7
trans_matrix1[2,3] = 0.7
# 应用旋转矩阵到坐标轴
...
data = {
    ...
    'target_pose': transform_matrix_list1,
